...
Defines the requirements for translating natural-language questions into read-only SQL queries
via a Gemini LLM agent and a LangGraph-compatible node (FR-1, FR-2).
## Requirements
