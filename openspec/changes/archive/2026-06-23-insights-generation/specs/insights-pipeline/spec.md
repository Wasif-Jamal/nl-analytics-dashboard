# Spec Delta: insights-pipeline (insights-generation change)

## Delta Summary

Introduces the InsightAgent, InsightTools, InsightOutput schema, stub agents for
Visualization and Follow-Up, and the conditional parallel fan-out in AnalyticsGraph.
All requirements in this file are new additions to the system.
