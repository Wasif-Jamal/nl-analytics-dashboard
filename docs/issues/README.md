...
|---|---|---|---|
| 1 | [NL Querying & SQL Generation](01-nl-querying-sql-generation.md) | §6.1, §7; FR-1, FR-2 | `area:sql` |
| 2 | [SQL Validation & Read-Only Enforcement](02-sql-validation-read-only.md) | §6.2, §9; FR-3 | `area:sql` |
| 3 | [Query Execution](03-query-execution.md) | §6.2; FR-4 | `area:sql` |
